...
export default {
  ...
  methods:{
      sub(){
         var that = this;    
          this.req.post(that.API_PROXY + '/admin/create_ad',that.form)
            .then((res) =>{   
      ...
      getBanners(){
          var that = this;    
          this.req.get(that.API_PROXY + '/banners')
            .then((res) =>{  
      ...
      getBannerItems(){
          ...
          console.log('xxx');
          this.req.get(that.API_PROXY + '/banner_all_item')
            .then((res) =>{                
      ...
      del(id,index){
        ...
        this.$confirm('是否删除?', '提示', {
          ...
          this.req.put(that.API_PROXY + '/admin/del_ad',{id:id})
          .then((res) =>{    
