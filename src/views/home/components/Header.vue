...
export default {
	...
	methods:{	 
       ...
       edit(){
   			...
   			//箭头函数()=>{ }
       		this.req.put(this.API_PROXY + '/admin/edit_pwd',this.form).then((res)=>{ 
...
.header{
	...
	.head-img img{height: 40px;width: 40px;padding-top: 10px}
	.head-x{padding-right: 35px;line-height:60px;}
	.head-img-click {
		cursor:pointer;
	}
}
