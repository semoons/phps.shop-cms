<template> 
	<div class="btn">   
			<el-row><el-button type="primary" class="btn" @click="addbox = true">添加商品分类</el-button></el-row>
			<el-dialog title="" :visible.sync="addbox" style='width: 80%'>
...
<script> 
	export default {
		...
		methods:{			
			...
			onSubmit(){ 
		        var that = this;
		        this.req.post(that.API_PROXY + '/admin/add_category',{form:that.addform})
		  			.then((res) =>{ 
